...
var getPastEvents = function (config) {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, (0, utils_1.fetchPage)("https://www.hltv.org/events/archive?".concat(query, "&offset=").concat(page * 50), config.loadPage)];
                case 3:
                    ...
                    events.push.apply(events, $('a.small-event')
                        ...
                        var name = el
                            ...
                            .find('.text-ellipsis')
                            .text();
                        var type = (0, EventType_1.fromText)(el.find('.table tr').first().find('td').last().text());
                        var dateStart = el
