"use strict";var W=Object.create;var S=Object.defineProperty;var q=Object.getOwnPropertyDescriptor;var X=Object.getOwnPropertyNames;var Z=Object.getPrototypeOf,Q=Object.prototype.hasOwnProperty;var K=(a,t)=>{for(var e in t)S(a,e,{get:t[e],enumerable:!0})},Y=(a,t,e,n)=>{if(t&&typeof t=="object"||typeof t=="function")for(let i of X(t))!Q.call(a,i)&&i!==e&&S(a,i,{get:()=>t[i],enumerable:!(n=q(t,i))||n.enumerable});return a};var $=(a,t,e)=>(e=a!=null?W(Z(a)):{},Y(t||!a||!a.__esModule?S(e,"default",{value:a,enumerable:!0}):e,a)),_=a=>Y(S({},"__esModule",{value:!0}),a);var nt={};K(nt,{ICalAlarm:()=>c,ICalAlarmRelatesTo:()=>F,ICalAlarmType:()=>V,ICalAttendee:()=>f,ICalAttendeeRole:()=>O,ICalAttendeeStatus:()=>M,ICalAttendeeType:()=>w,ICalCalendar:()=>y,ICalCalendarMethod:()=>P,ICalCategory:()=>p,ICalEvent:()=>D,ICalEventBusyStatus:()=>z,ICalEventClass:()=>B,ICalEventRepeatingFreq:()=>b,ICalEventStatus:()=>L,ICalEventTransparency:()=>U,ICalWeekday:()=>E,default:()=>at,escape:()=>r,foldLines:()=>R,formatDate:()=>o,formatDateTZ:()=>T});module.exports=_(nt);function o(a,t,e,n){if(a?.startsWith("/")&&(a=a.substr(1)),typeof t=="string"||t instanceof Date){let i=new Date(t),s=i.getUTCFullYear()+String(i.getUTCMonth()+1).padStart(2,"0")+i.getUTCDate().toString().padStart(2,"0");return a&&(s=i.getFullYear()+String(i.getMonth()+1).padStart(2,"0")+i.getDate().toString().padStart(2,"0")),e?s:a?(s+="T"+i.getHours().toString().padStart(2,"0")+i.getMinutes().toString().padStart(2,"0")+i.getSeconds().toString().padStart(2,"0"),s):(s+="T"+i.getUTCHours().toString().padStart(2,"0")+i.getUTCMinutes().toString().padStart(2,"0")+i.getUTCSeconds().toString().padStart(2,"0")+(n?"":"Z"),s)}else if(x(t)){let i=a?j(t)&&!t.tz()?t.clone().tz(a):t:n||e&&j(t)&&t.tz()?t:t.utc();return i.format("YYYYMMDD")+(e?"":"T"+i.format("HHmmss")+(n||a?"":"Z"))}else if(v(t)){let i=a?t.setZone(a):n||e&&t.zone.type!=="system"?t:t.setZone("utc");return i.toFormat("yyyyLLdd")+(e?"":"T"+i.toFormat("HHmmss")+(n||a?"":"Z"))}else{let i=t;if(a)i=typeof t.tz=="function"?t.tz(a):t;else if(!n)if(typeof t.utc=="function")i=t.utc();else throw new Error("Unable to convert dayjs object to UTC value: UTC plugin is not available!");return i.format("YYYYMMDD")+(e?"":"T"+i.format("HHmmss")+(n||a?"":"Z"))}}function T(a,t,e,n){let i="",s=n?.floating||!1;return n?.timezone&&(i=";TZID="+n.timezone,s=!0),t+i+":"+o(a,e,!1,s)}function r(a,t){return String(a).replace(t?/[\\"]/g:/[\\;,]/g,function(e){return"\\"+e}).replace(/(?:\r\n|\r|\n)/g,"\\n")}function R(a){return a.split(`\r
...
`)),this.data.location&&"geo"in this.data.location&&this.data.location.geo&&(t+="GEO:"+r(this.data.location.geo?.lat,!1)+";"+r(this.data.location.geo?.lon,!1)+`\r
...
`),t+=A(this.data),this.data.created&&(t+="CREATED:"+o(this.calendar.timezone(),this.data.created)+`\r
...
`),t+=`END:VEVENT\r
`,t}};var P=(m=>(m.PUBLISH="PUBLISH",m.REQUEST="REQUEST",m.REPLY="REPLY",m.ADD="ADD",m.CANCEL="CANCEL",m.REFRESH="REFRESH",m.COUNTER="COUNTER",m.DECLINECOUNTER="DECLINECOUNTER",m))(P||{}),y=class{data;constructor(t={}){this.data={prodId:"//sebbo.net//ical-generator//EN",method:null,name:null,description:null,timezone:null,source:null,url:null,scale:null,ttl:null,events:[],x:[]},t.prodId!==void 0&&this.prodId(t.prodId),t.method!==void 0&&this.method(t.method),t.name!==void 0&&this.name(t.name),t.description!==void 0&&this.description(t.description),t.timezone!==void 0&&this.timezone(t.timezone),t.source!==void 0&&this.source(t.source),t.url!==void 0&&this.url(t.url),t.scale!==void 0&&this.scale(t.scale),t.ttl!==void 0&&this.ttl(t.ttl),t.events!==void 0&&this.events(t.events),t.x!==void 0&&this.x(t.x)}prodId(t){if(!t)return this.data.prodId;if(typeof t=="string")return this.data.prodId=t,this;if(typeof t!="object")throw new Error("`prodid` needs to be a string or an object!");if(!t.company)throw new Error("`prodid.company` is a mandatory item!");if(!t.product)throw new Error("`prodid.product` is a mandatory item!");let e=(t.language||"EN").toUpperCase();return this.data.prodId="//"+t.company+"//"+t.product+"//"+e,this}method(t){return t===void 0?this.data.method:t?(this.data.method=d(P,t),this):(this.data.method=null,this)}name(t){return t===void 0?this.data.name:(this.data.name=t?String(t):null,this)}description(t){return t===void 0?this.data.description:(this.data.description=t?String(t):null,this)}timezone(t){return t===void 0?this.data.timezone?.name||null:(t==="UTC"?this.data.timezone=null:typeof t=="string"?this.data.timezone={name:t}:t===null?this.data.timezone=null:this.data.timezone=t,this)}source(t){return t===void 0?this.data.source:(this.data.source=t||null,this)}url(t){return t===void 0?this.data.url:(this.data.url=t||null,this)}scale(t){return t===void 0?this.data.scale:(t===null?this.data.scale=null:this.data.scale=t.toUpperCase(),this)}ttl(t){return t===void 0?this.data.ttl:(G(t)?this.data.ttl=t.asSeconds():t&&t>0?this.data.ttl=t:this.data.ttl=null,this)}createEvent(t){let e=t instanceof D?t:new D(t,this);return this.data.events.push(e),e}events(t){return t?(t.forEach(e=>this.createEvent(e)),this):this.data.events}clear(){return this.data.events=[],this}x(t,e){if(t===void 0)return l(this.data);if(typeof t=="string"&&typeof e=="string")l(this.data,t,e);else if(typeof t=="object")l(this.data,t);else throw new Error("Either key or value is not a string!");return this}toJSON(){return Object.assign({},this.data,{timezone:this.timezone(),events:this.data.events.map(t=>t.toJSON()),x:this.x()})}length(){return this.data.events.length}toString(){let t="";return t=`BEGIN:VCALENDAR\r
VERSION:2.0\r
